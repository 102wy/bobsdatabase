    ...
    <Wrap>
      ...
      {levelIndex >= 2 && (
        <>
          ...
          <p>
            ...
            <br />
            주사로 투여하는 경우에는 주사기에 담는 과정을 전문가가 해준다면
            투여는 일반인도 가능하지만, 음식물에 섞어 넣는 것은 전문가만이 할 수
            있다.
            <br />
            음식과 궁합이 상당히 좋지 않아 대부분의 음식에선 효능의 약화를
            보였다.
            <br />
            하지만 전문가들은 액체에 섞을 때 자신들만의 독특한 스터링을 한다면
            약효의 성능 저하없이 제조가 가능하다.
          </p>
        </>
      )}
      <br />
      ...
      {levelIndex >= 3 && (
        <>
          ...
          <p>
            해독방법은 수크로스를 185도 이상으로 가열하여 액상의 상태를 만들고
            탄산수소 나트륨 50:1 정도로 첨가하여 다회 스터링해서 일정하게
            섞는다.
            <br />
