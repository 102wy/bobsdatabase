  ...
  return (
    <Wrap>
      ...
      <p>
        ...
        <br />
        생전 가족은 부인 <span className="keyword">성해숙</span>과 딸
      ...
      {levelIndex >= 1 && (
        <>
          ...
          <p>
            ...
            자살하였다고 적혀있다.
            <br />
            와이프 <span className="keyword">성해숙</span>과는 우연히 같은
            담배를 핀다는 공통점으로 만나 1년 연애하였고 2014년에 결혼했다.
            <br />
      ...
      {levelIndex >= 2 && (
        <>
          ...
          <p>
            ...
            <br />
            그의 노래를 들은 혹자는 <span className="keyword">민광선</span>을
            가리켜서 가객, 노래하는 시인, 노래하는 철학자라고 부른다.
      ...
      {levelIndex >= 3 && (
        <>
          ...
          <p>
            <span className="keyword">민광선</span>은{" "}
            <span className="keyword">성해숙</span>이 신흥종교에 빠지게 된 걸
            알았고, 모았던 재산들이 <span className="keyword">성해숙</span>과
            <span className="keyword"> 성해준</span>에 의해서 그 종교에 헌납됨을
            알게 되어 이혼을 준비하던 중에 사망하였다.
          </p>
        </>
      )}
    </Wrap>
