...
const Page1 = () => {
  ...
  return (
    <Wrap>
      ...
      <p>
        <iframe width="auto" height="315" src="https://www.youtube.com/embed/FHxJjFlvE7M" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
      </p>
      ...
      {keyword >= utils.Level[3] && (
        <>
          ...
          <p>
            ...
            <br />
            그리고 성해숙은 전공을 살려 교단 내 약물을 담당하게 되었다. 민광선은 성해숙이 재산을 교단에 헌납하게 된 것을 알고 이혼을 준비한다.
            <br />
