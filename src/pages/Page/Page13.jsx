    ...
    <Wrap>
      ...
      {keyword >= utils.Level[2] && (
        <>
          ...
          <p>
            큰 체구의 소유자로 어린 시절부터 무서운게 없었던 성해준은 심각한
            폭력성을 보였고 구치소와 교도소를 수차례 들락날락 거렸다.
            <br />
      ...
      {keyword >= utils.Level[3] && (
        <>
          ...
          <p>
            ...
            애기동산에 가입하게 된다.
            <br />
            그리고 성해준의 폭력성을 알아본 김기숙은 신도들의 폭행, 살해등을
            지시했고, 그렇게 애기동산의 간부까지 오르게 된다.
            <br />
            이 과정에서 자연스럽게 자살로 보이는 교살방법들을 알게 된다.
            <br />
            그리고 동생 성해숙을 가입시키고 민광선의 재산을 빼돌려 헌납하게
            된다.
          </p>
        </>
      )}
