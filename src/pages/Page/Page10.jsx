    ...
    <Wrap>
      ...
      {keyword >= utils.Level[1] && (
        <>
          ...
          <p>
            교주 김기숙은 '애기농장'이라는 것을 세웠고, '갈 곳 없는 신도들을
            모아 공동체를 만들고 떡 장사, 어묵 장사, 음반 장사 등으로 땅을
            샀다.'고 주장한다.
            <br />
            얼핏 보면 일반적인 개신교 종파 중 하나 같겠지만, 실상은 개신교에서
            예수만 빼고 그 자리에 김기숙을 대입한 전형적인 사이비 종교에
            불과하다.
            <br />이 종교의 교리는 일단 김기숙은 신이며 3살짜리 애기이기 때문에
            '애기야'라고 불러야 하며 어떤 말을 해도, 어떤 짓을 해도 죄가 되지
            않는다는 것이었다.
            <br />
            ...
            키워드암호의 일종일거라 전문가들은 이야기했다.
            <br />
            그리고 고액헌금자나 기여를 많이 한 신도들은 이 교단의 간부가 되고,
            새나라 주민이라 불렀다. 새나라 주민들은 신도번호를 부여받는데, 그
            신도번호는 전화번화 앞 4자리와 뒷 4자리를 더한 숫자일 뿐이었다.
            <br />
      ...
      {keyword >= utils.Level[2] && (
        <>
          ...
          <p>
            2004년에는 첫 수익사업체 '바코드레코드물'를 세워 초기에는 트럭으로
            다른 음반점에 카세트 등 음반을 팔다가 2006년 대구 동성로에 자체
            매장을 처음 연 후 특유의 가격파괴 전략을 세워 광속으로
            음반도매업계를 장악하며 안정적인 사업체까지 가지게 되었다.
            <br />
            그 과정에서 김기숙은 회장으로 취임하고 대외적인 활동은 애기동산
            간부인 최진성이 대표이사로 활동한다.
            <br />
      ...
      {keyword >= utils.Level[3] && (
        <>
          ...
          <p>
            김기숙은 고도의 가스라이팅을 통하여 신도들의 전재산을 헌납받았고,
            재산이 없는 자들은 노동력을 갈취했다.
            <br />
